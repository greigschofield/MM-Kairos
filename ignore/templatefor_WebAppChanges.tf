...
#change create-online (find and replace)
#create new file

resource "azurerm_windows_web_app" "azmmclientrg-webbapp-create-online" {
  app_settings = {
...
/**
resource "azurerm_app_service_custom_hostname_binding" "azmmclientrg-custombinding-webapp-create-online1" {
  app_service_name    = "create-online-matchmakersoftware"
  hostname            = "create-online-matchmakersoftware.azurewebsites.net"
  resource_group_name = "azmmclientapps"
}
*/
...
resource "azurerm_app_service_certificate_binding" "azmmclientrg-custombinding-cert-webapp-create-online2" {
  hostname_binding_id = azurerm_app_service_custom_hostname_binding.azmmclientrg-custombinding-webapp-create-online2.id
  certificate_id      = azurerm_app_service_certificate.azmmclientrg-365.id
  ssl_state           = "SniEnabled"
}


resource "azurerm_monitor_smart_detector_alert_rule" "azmmclientrg-smartalert-webapp-create-online" {
  description         = "Failure Anomalies notifies you of an unusual rise in the rate of failed HTTP requests or dependency calls."
  detector_type       = "FailureAnomaliesDetector"
  frequency           = "PT1M"
  name                = "Failure Anomalies - create-online-matchmakersoftware"
  resource_group_name = "AZMMClientApps"
  scope_resource_ids  = ["/subscriptions/2bd29ed6-34a6-42d7-8235-293e8ee67447/resourcegroups/azmmclientapps/providers/microsoft.insights/components/create-online-matchmakersoftware"]
  severity            = "Sev3"
  action_group {
...
resource "azurerm_application_insights" "azmmclientrg-appinsight-webapp-create-online" {
