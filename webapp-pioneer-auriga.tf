...
#change pioneer-auriga (find and replace)
#change the service plan ID to match which web app service plan you want it to sit on...

#create new file

resource "azurerm_windows_web_app" "azmmclientrg-webbapp-pioneer-auriga" {
  app_settings = {
    ...
    MM_DEFAULT_VERSION                         = "mmakerpioneer-auriga"
  ...
  name                      = "pioneer-auriga-matchmakersoftware"
...
/**
resource "azurerm_app_service_custom_hostname_binding" "azmmclientrg-custombinding-webapp-pioneer-auriga1" {
  app_service_name    = "pioneer-auriga-matchmakersoftware"
  hostname            = "pioneer-auriga-matchmakersoftware.azurewebsites.net"
  resource_group_name = "azmmclientapps"
}
*/

resource "azurerm_app_service_custom_hostname_binding" "azmmclientrg-custombinding-webapp-pioneer-auriga2" {
  app_service_name    = "pioneer-auriga-matchmakersoftware"
  hostname            = "pioneer-auriga.matchmakersoftware.com"
  resource_group_name = "azmmclientapps"
  depends_on = [
    azurerm_windows_web_app.azmmclientrg-webbapp-pioneer-auriga,

  ]
}

resource "azurerm_app_service_certificate_binding" "azmmclientrg-custombinding-cert-webapp-pioneer-auriga2" {
  hostname_binding_id = azurerm_app_service_custom_hostname_binding.azmmclientrg-custombinding-webapp-pioneer-auriga2.id
...
resource "azurerm_monitor_smart_detector_alert_rule" "azmmclientrg-smartalert-webapp-pioneer-auriga" {
  description         = "Failure Anomalies notifies you of an unusual rise in the rate of failed HTTP requests or dependency calls."
  detector_type       = "FailureAnomaliesDetector"
  frequency           = "PT1M"
  name                = "Failure Anomalies - pioneer-auriga-matchmakersoftware"
  resource_group_name = "AZMMClientApps"
  scope_resource_ids  = ["/subscriptions/2bd29ed6-34a6-42d7-8235-293e8ee67447/resourcegroups/azmmclientapps/providers/microsoft.insights/components/pioneer-auriga-matchmakersoftware"]
  severity            = "Sev3"
  action_group {
...
resource "azurerm_application_insights" "azmmclientrg-appinsight-webapp-pioneer-auriga" {
